...
$('.home-inline-items-slick').slick({
  ...
  slidesToScroll: 1,
   adaptiveHeight: true,
prevArrow:
			'<div class="home-inline-items-carousel__nav home-inline-items-carousel__nav--prev"><i class="icon icon--left-l"></i></div>',
			nextArrow:
			'<div class="home-inline-items-carousel__nav home-inline-items-carousel__nav--next"><i class="icon icon--right-l"></i></div>',
...
$('.home-inline-items-slick-2').slick({
  arrows: true,
  dots: false,
  swipe: false,
  infinite: true,
...
$('.home-inline-items-slick-3').slick({
  arrows: true,
  dots: false,
  swipe: false,
  infinite: false,
